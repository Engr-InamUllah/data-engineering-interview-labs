# Data Engineering Interview Labs

Practical exercises covering SQL, Python, PySpark, dimensional modeling, orchestration, and scalable data-system design.

## Architecture

`	ext
Problem -> Attempt -> Tests -> Reference solution -> Discussion
`

## Technology stack

SQL, Python, PySpark, Docker
